...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
    ({ className, label, error, icon, endIcon, ...props }, ref) => {
        return (
            <div className="w-full space-y-2">
                ...
                <div className="relative group">
                    ...
                    />
                    {endIcon && (
                        <div className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-teal-600 transition-colors cursor-pointer">
                            {endIcon}
                        </div>
                    )}
                </div>
